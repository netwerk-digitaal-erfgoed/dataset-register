...
| ------------------------------------------------------------ | ------------------------------------------------------------------ | ---------------------------------------------------------------------- | ------------------------------------------------------------ |
| [`dcat:accessURL`](https://www.w3.org/TR/vocab-dcat-3/)      | Distribution URL.                                                  | `<https://example.com/data.nt.gz>`                                     | [`schema:contentUrl`](https://schema.org/contentUrl)         |
...
| [`dct:modified`](http://purl.org/dc/terms/issued)            | Distribution last modification date.                               | `"2024-06-01"^^xsd:date`                                               | [`schema:dateModified`](https://schema.org/dateModified)     |
...
| [`dct:language`](http://purl.org/dc/terms/language)          | Distribution language.                                             | `"nl-NL"`                                                              | [`schema:inLanguage`](https://schema.org/inLanguage)         |
