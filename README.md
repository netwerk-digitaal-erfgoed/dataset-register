...
| [`foaf:page`](http://xmlns.com/foaf/0.1/page)                | Human-readable web page for the distribution (UI or download landing page). | `<https://example.com/sparql-ui>`                                      | [`schema:mainEntityOfPage`](https://schema.org/mainEntityOfPage)        |
